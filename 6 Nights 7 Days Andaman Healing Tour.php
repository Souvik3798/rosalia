...
<div class="hero-section">
    <div class="hero-content">
        <h1>6 Nights 7 Days Historical Healing Tour</h1>
        <p>Immerse yourself in the history and natural beauty of the Andaman Islands with this healing journey.</p>
    </div>
</div>
<div class="package-container">
    ...
    <div class="itinerary-timeline">
        <div class="timeline-item">
            ...
            <p>Upon arrival,
                you’ll be welcomed and escorted to your hotel. Visit Carbyn’s Cove Beach and the historic Cellular Jail,
                followed by a light and sound show.</p>
        </div>
        <div class="timeline-item">
            <h2 class="day-title"><i class="fas fa-umbrella-beach"></i>Day 2: Port Blair - Havelock Island (Radhanagar Beach)</h2>
            <p>Take a ferry to Havelock Island and check into your hotel. Visit Radhanagar Beach,
                rated as Asia's best beach by Times Magazine, before returning to the hotel for an overnight stay.</p>
        </div>
        <div class="timeline-item">
            <h2 class="day-title"><i class="fas fa-ship"></i>Day 3: Havelock Island - Kalapather Beach - Port Blair</h2>
            <p>After breakfast,
                visit Kalapather Beach. Return to Port Blair by ferry and check into your hotel for the night.</p>
        </div>
        <div class="timeline-item">
            <h2 class="day-title"><i class="fas fa-water"></i>Day 4: Ross Island & North Bay Coral Island</h2>
            <p>Enjoy a full-day trip to Ross Island and North Bay Coral Island,
                with Glass Bottom Boat rides for coral viewing. Return to your hotel for an overnight stay.</p>
        </div>
        <div class="timeline-item">
            <h2 class="day-title"><i class="fas fa-city"></i>Day 5: City Tour - Chidiyatapu Beach</h2>
            <p>Explore Chatham Saw Mill,
                Sagarika Emporium,
                and the Anthropological Museum. End the day with a sunset at Chidiyatapu Beach.</p>
        </div>
        <div class="timeline-item">
            <h2 class="day-title"><i class="fas fa-mountain"></i>Day 6: Baratang</h2>
            <p>Depart early for Baratang Island. Enjoy a thrilling journey through mangroves and trek to the Lime Stone Caves before returning to Port Blair.</p>
        </div>
        <div class="timeline-item">
            <h2 class="day-title"><i class="fas fa-plane-departure"></i>Day 7: Departure from Port Blair</h2>
            <p>After breakfast,
                proceed to the airport for departure,
                carrying memories of a wonderful Andaman experience.</p>
        </div>
    </div>
    <div class="inclusion-exclusion">
        <div class="inclusion">
            ...
            <ul class="points-list">
                ...
                <li>All entry permits and tickets</li>

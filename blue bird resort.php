...
<main class="hotel-detail-main">
    ...
    <section class="hotel-header position-relative" style="background: linear-gradient(rgba(89, 196, 90, 0.9), rgba(89, 196, 90, 0.8)), url('https://tse3.mm.bing.net/th?id=OIP.hhI8iTY7QLXhFBqPBnmamAHaE8&pid=Api') center/cover; color: white; padding: 120px 0 80px 0;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1 class="hotel-title display-4 mb-3">Blue Bird Resort</h1>
                    ...
                    <p class="hotel-location fs-5">
                        <i class="fas fa-map-marker-alt me-2"></i> Vijay Nagar Beach No.5, Swaraj Dweep, Havelock Island, South Andaman
                ...
                <div class="col-md-4 text-end">
                    <div class="price-tag glass-morphism p-4">
                        ...
                        <h2 class="display-5 fw-bold mb-3">₹4,500<small class="fs-6 text-white">/night</small></h2>
                        <button class="btn btn-light btn-lg w-100" onclick="window.open('https://wa.me/9474255735?text=I want to check availability at Blue Bird Resort', '_blank')"><i class="fas fa-calendar-alt me-2"></i>Check Availability</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-3">
                <div class="col-md-8">
                    <div class="position-relative gallery-main">
                        <img src="https://tse3.mm.bing.net/th?id=OIP.hhI8iTY7QLXhFBqPBnmamAHaE8&pid=Api" alt="Blue Bird Main Image" class="img-fluid rounded main-image" style="width: 100%; height: 500px; object-fit: cover;">
                    ...
                    <div class="row g-3">
                        <div class="col-6 col-md-12">
                            <div class="gallery-item position-relative">
                                <img src="https://tse3.mm.bing.net/th?id=OIP.3zZO1zSyhFIynN1UMdeSeQHaE8&pid=Api" alt="Gallery Image 1" class="img-fluid rounded" style="width: 100%; height: 240px; object-fit: cover;">
                                <div class="overlay"></div>
                            </div>
                        </div>
                        <div class="col-6 col-md-12">
                            <div class="gallery-item position-relative">
                                <img src="https://tse2.mm.bing.net/th?id=OIP.4U5pLEw-YRTKkYPzH8Gv_QHaE7&pid=Api" alt="Gallery Image 2" class="img-fluid rounded" style="width: 100%; height: 240px; object-fit: cover;">
                                <div class="overlay"></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="description-card bg-white p-4 rounded shadow-sm">
                        ...
                        <p class="mt-3 lead">Blue Bird Resort is an eco-friendly retreat on Havelock Island, offering a sustainable and unique experience with its bamboo and cane cottages. Located near Vijay Nagar Beach, it provides easy access to the pristine beach environment of Swaraj Dweep.</p>
                        ...
                        <div id="amenities" class="amenities mt-5">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-4">
                                    <div class="amenity-card p-3 border rounded text-center">
                                        <i class="fas fa-shuttle-van fa-2x mb-3" style="color: #59c45a;"></i>
                                        <h4 class="h6 mb-0">Shuttle Service</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="room-card bg-white rounded shadow-sm h-100">
                        <div class="position-relative">
                            <img src="https://tse4.mm.bing.net/th?id=OIP.u45icGHQ49yFDP7CORyJnwHaED&pid=Api" alt="Deluxe Room" class="img-fluid rounded-top" style="width: 100%; height: 250px; object-fit: cover;">
                            <span class="badge bg-success position-absolute top-0 end-0 m-3">Popular</span>
                        </div>
                        <div class="room-info p-4">
                            <h3 class="h4 mb-3">Eco-Friendly Deluxe Room</h3>
                            <p class="text-muted mb-4">Experience a sustainable stay in eco-friendly accommodations.</p>
                            ...
                            <div class="price-book d-flex align-items-center justify-content-between">
                                ...
                                <a href="https://wa.me/918900943735?text=I'm%20interested%20in%20booking%20a%20Deluxe%20Room%20at%20Blue%20Bird%20Resort.%20Please%20provide%20more%20details."

...
<main class="hotel-detail-main">
    ...
    <section class="hotel-header position-relative" style="background: linear-gradient(rgba(89, 196, 90, 0.9), rgba(89, 196, 90, 0.8)), url('https://cf.bstatic.com/xdata/images/hotel/max1024x768/312197777.jpg?k=5561c2b797741832e34e8dd080cce29ed9a03224bdb0339ea2b775015f73af4a&o=&hp=1') center/cover; color: white; padding: 120px 0 80px 0;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1 class="hotel-title display-4 mb-3">Welcomhotel by ITC Hotels, Bay Island, Port Blair</h1>
                    <div class="hotel-rating mb-3">
                        ...
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <span class="ms-2">(4.5/5 from 1,713 reviews)</span>
                    </div>
                    <p class="hotel-location fs-5">
                        <i class="fas fa-map-marker-alt me-2"></i> Marine Hill, Port Blair, Andaman and Nicobar Islands
                ...
                <div class="col-md-4 text-end">
                    <div class="price-tag glass-morphism p-4">
                        ...
                        <h2 class="display-5 fw-bold mb-3">₹16,500<small class="fs-6 text-white">/night</small></h2>
                        <button class="btn btn-light btn-lg w-100" onclick="window.open('https://wa.me/918900943735?text=I want to check availability at Welcomhotel by ITC Hotels, Bay Island, Port Blair', '_blank')"><i class="fas fa-calendar-alt me-2"></i>Check Availability</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-3">
                <div class="col-md-8">
                    <div class="position-relative gallery-main">
                        <img src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/312197777.jpg?k=5561c2b797741832e34e8dd080cce29ed9a03224bdb0339ea2b775015f73af4a&o=&hp=1" alt="Welcomhotel Main Image" class="img-fluid rounded main-image" style="width: 100%; height: 500px; object-fit: cover;">
                    ...
                    <div class="row g-3">
                        <div class="col-6 col-md-12">
                            <div class="gallery-item position-relative">
                                <img src="https://www.itchotels.com/content/dam/itchotels/in/umbrella/welcomHotel/hotels/welcomhotelbayisland-port-blair/images/overview-landing-page/headmast/desktop/port-blair-beach.png" alt="Gallery Image 1" class="img-fluid rounded" style="width: 100%; height: 240px; object-fit: cover;">
                                <div class="overlay"></div>
                            </div>
                        </div>
                        <div class="col-6 col-md-12">
                            <div class="gallery-item position-relative">
                                <img src="https://media.easemytrip.com/media/Hotel/SHL-240927530372299/RoomImage/RoomImageAEyZCj.jpg" alt="Gallery Image 2" class="img-fluid rounded" style="width: 100%; height: 240px; object-fit: cover;">
                                <div class="overlay"></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="description-card bg-white p-4 rounded shadow-sm">
                        ...
                        <p class="mt-3 lead">Welcomhotel by ITC Hotels, Bay Island, Port Blair, is a luxurious 5-star hotel offering a perfect blend of comfort, elegance, and natural beauty. Nestled in the serene Andaman and Nicobar Islands, the hotel provides guests with modern amenities and stunning views of the Bay of Bengal. :contentReference[oaicite:0]{index=0}</p>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-4">
                                    <div class="amenity-card p-3 border rounded text-center">
                                        ...
                                        <h4 class="h6 mb-0">Infinity Pool</h4>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="amenity-card p-3 border rounded text-center">
                                ...
                                <div class="col-md-4">
                                    <div class="amenity-card p-3 border rounded text-center">
                                        ...
                                        <h4 class="h6 mb-0">Spa and Wellness Center</h4>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="amenity-card p-3 border rounded text-center">
                                ...
                                <div class="col-md-4">
                                    <div class="amenity-card p-3 border rounded text-center">
                                        ...
                                        <h4 class="h6 mb-0">Airport Transfers</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="quick-facts bg-white p-4 rounded shadow-sm">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="d-flex align-items-center">
                                <i class="fas fa-umbrella-beach me-3" style="color: #59c45a;"></i>
                                <div>
                ...
                <div class="col-md-4">
                    <div class="room-card bg-white rounded shadow-sm h-100">
                        <div class="position-relative">
                            <img src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/312197201.jpg?k=18620f51b505b5e67936fd19b85740cb731fb22ebb3758661e5603a6d59daf2f&o=&hp=1" alt="Deluxe Room" class="img-fluid rounded-top" style="width: 100%; height: 250px; object-fit: cover;">
                        ...
                        <div class="room-info p-4">
                            ...
                            <div class="price-book d-flex align-items-center justify-content-between">
                                <div class="price">
                                    <span class="fs-3 fw-bold">Rs. 16,500</span>
                                </div>
                                <a href="https://wa.me/918900943735?text=I'm%20interested%20in%20booking%20a%20Deluxe%20Room%20at%20Welcomhotel%20by%20ITC%20Hotels,%20Bay%20Island,%20Port%20Blair.%20Please%20provide%20more%20details."

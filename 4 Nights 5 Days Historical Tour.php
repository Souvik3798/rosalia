...
<div class="hero-section">
    <div class="hero-content">
        <h1>4 Nights 5 Days Historical Tour Itinerary</h1>
        <p>Explore the history and scenic beauty of the Andaman Islands with this comprehensive 5-day package.</p>
    </div>
</div>
...
<div class="package-container">
    ...
    <div class="itinerary-timeline">
        <div class="timeline-item">
            ...
            <p>Welcome to Andaman! After arrival, check into your hotel, then proceed to Corbyn's Cove Beach followed by a visit to the historic Cellular Jail. Enjoy a captivating light and sound show in the evening.</p>
        ...
        <div class="timeline-item">
            <h2 class="day-title"><i class="fas fa-umbrella-beach"></i>Day 2: Port Blair - Havelock Island - Port Blair</h2>
            <p>After breakfast, board a ferry to Havelock Island and visit the stunning Radhanagar Beach, ranked Asia's best beach. Return to Port Blair in the evening.</p>
        </div>

        <div class="timeline-item">
            <h2 class="day-title"><i class="fas fa-ship"></i>Day 3: Ross Island & North Bay Coral Island Visit</h2>
            <p>Full-day tour of Ross Island and North Bay Island, where you can explore ruins from the British era and view corals from glass-bottom boats.</p>
        </div>

        <div class="timeline-item">
            <h2 class="day-title"><i class="fas fa-city"></i>Day 4: City Tour & Chidiyatapu Beach</h2>
            <p>Explore Port Blair's landmarks, including Chatham Saw Mill, Anthropological Museum, and Sagarika Emporium. Later, visit Chidiyatapu Beach to enjoy wildlife and a beautiful sunset view.</p>
        </div>

        <div class="timeline-item">
            <h2 class="day-title"><i class="fas fa-plane-departure"></i>Day 5: Departure from Port Blair</h2>
            <p>After breakfast, transfer to the airport for your journey home, carrying unforgettable memories of the Andaman Islands.</p>
        </div>
    </div>
    ...
    <div class="price-section">
        ...
        <h3>₹42,000/- per 2 person</h3>
        <a href="https://wa.me/918900943735?text=I%20want%20to%20book%20package%20-%204%20Nights%205%20Days%20Historical%20Tour" target="_blank" class="cta-button">Book Now</a>
    </div>

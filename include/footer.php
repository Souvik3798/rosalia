    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-3 col-md-2">
                <div class="ul-ft">
                    <ul>
                        ...
                        <li><a href="car-list.php" title="">Cab</a></li>
                        <li><a href="cruise-list.php" title="">Cruises</a></li>
                        <li><a href="water-sports.php" title="">Water Sports</a></li>
                        <li><a href="entry-tickets.php" title="">Entry Tickets</a></li>
            ...
            <div class="col-sm-6 col-md-4">
                ...
                <!--CopyRight-->
                <p class="copyright">
                    &copy; 2024 Rosalia Travel™. All rights reserved.
                </p>
                <!--CopyRight-->
            </div>
...
<script
    type="text/javascript"
    src="js/library/owl.carousel.min.js"></script>
<script type="text/javascript" src="js/library/parallax.min.js"></script>
<script
    type="text/javascript"
    src="js/library/jquery.nicescroll.js"></script>
<script
    type="text/javascript"

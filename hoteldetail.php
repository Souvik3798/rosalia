...
<main class="hotel-detail-main">
    ...
    <section class="hotel-header position-relative" style="background: linear-gradient(rgba(89, 196, 90, 0.9), rgba(89, 196, 90, 0.8)), url('images/hotel/header-bg.jpg') center/cover; color: white; padding: 120px 0 80px 0;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1 class="hotel-title display-4 mb-3">Hotel Paradise Resort</h1>
                    ...
                    <p class="hotel-location fs-5">
                        <i class="fas fa-map-marker-alt me-2"></i> 123 Beach Road, Paradise Island
                ...
                <div class="col-md-4 text-end">
                    <div class="price-tag glass-morphism p-4">
                        ...
                        <h2 class="display-5 fw-bold mb-3">$199<small class="fs-6 text-white">/night</small></h2>
                        <button class="btn btn-light btn-lg w-100"><i class="fas fa-calendar-alt me-2"></i>Check Availability</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-3">
                <div class="col-md-8">
                    <div class="position-relative gallery-main">
                        <img src="images/hotel/main.jpg" alt="Hotel Main Image" class="img-fluid rounded main-image">
                    ...
                    <div class="row g-3">
                        <div class="col-6 col-md-12">
                            <div class="gallery-item position-relative">
                                <img src="images/hotel/gallery1.jpg" alt="Gallery Image 1" class="img-fluid rounded">
                                <div class="overlay"></div>
                            </div>
                        </div>
                        <div class="col-6 col-md-12">
                            <div class="gallery-item position-relative">
                                <img src="images/hotel/gallery2.jpg" alt="Gallery Image 2" class="img-fluid rounded">
                                <div class="overlay"></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="description-card bg-white p-4 rounded shadow-sm">
                        ...
                        <p class="mt-3 lead">Experience luxury and comfort at Hotel Paradise Resort. Nestled in the heart of Paradise Island, our hotel offers breathtaking views and world-class amenities. With our dedicated staff and premium services, we ensure your stay is nothing short of extraordinary.</p>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="room-card bg-white rounded shadow-sm h-100">
                        <div class="position-relative">
                            <img src="images/rooms/deluxe.jpg" alt="Deluxe Room" class="img-fluid rounded-top">
                            <span class="badge bg-success position-absolute top-0 end-0 m-3">Most Popular</span>
                        </div>
                        <div class="room-info p-4">
                            <h3 class="h4 mb-3">Deluxe Room</h3>
                            <p class="text-muted mb-4">Perfect for couples seeking a romantic getaway</p>
                            <ul class="room-features list-unstyled mb-4">
                                ...
                                <li class="mb-2"><i class="fas fa-mountain me-2"></i> Ocean View</li>
                            </ul>
                            <div class="price-book d-flex align-items-center justify-content-between">
                                <div class="price">
                                    <span class="fs-3 fw-bold">$199</span>
                                    <small class="text-muted">/night</small>
                                </div>
                                <button class="btn btn-success book-btn px-4">
                ...
                <div class="col-md-4">
                    <div class="room-card bg-white rounded shadow-sm h-100">
                        <div class="position-relative">
                            <img src="images/rooms/suite.jpg" alt="Suite Room" class="img-fluid rounded-top">
                            <span class="badge bg-primary position-absolute top-0 end-0 m-3">Premium</span>
                        </div>
                        <div class="room-info p-4">
                            <h3 class="h4 mb-3">Suite Room</h3>
                            <p class="text-muted mb-4">Luxury and space for an unforgettable stay</p>
                            <ul class="room-features list-unstyled mb-4">
                                <li class="mb-2"><i class="fas fa-bed me-2"></i> King Size Bed</li>
                            ...
                            <div class="price-book d-flex align-items-center justify-content-between">
                                <div class="price">
                                    <span class="fs-3 fw-bold">$299</span>
                                    <small class="text-muted">/night</small>
                                </div>
                                <button class="btn btn-success book-btn px-4">
                                    <i class="fas fa-calendar-check me-2"></i>Book Now
                ...
                <div class="col-md-4">
                    <div class="room-card bg-white rounded shadow-sm h-100">
                        <div class="position-relative">
                            <img src="images/rooms/family.jpg" alt="Family Room" class="img-fluid rounded-top">
                            <span class="badge bg-warning position-absolute top-0 end-0 m-3">Family Choice</span>
                        </div>
                        <div class="room-info p-4">
                            <h3 class="h4 mb-3">Family Room</h3>
                            <p class="text-muted mb-4">Spacious comfort for the whole family</p>
                            <ul class="room-features list-unstyled mb-4">
                            ...
                            <div class="price-book d-flex align-items-center justify-content-between">
                                <div class="price">
                                    <span class="fs-3 fw-bold">$259</span>
                                    <small class="text-muted">/night</small>
                                </div>
                                <button class="btn btn-success book-btn px-4">
                                    <i class="fas fa-calendar-check me-2"></i>Book Now
...
<style>
    /* Set base font size */
    html {
        font-size: 16px; /* Browser default but explicitly set */
    }
    ...
    .glass-morphism {
        ...
        font-size: 1.1rem; /* Added larger text */
    }
    ...
    .price-book .book-btn {
        background-color: #59c45a;
        transition: all 0.3s ease;
        font-size: 1.1rem; /* Increased button text */
    }
    ...
    @media (max-width: 768px) {
        .hotel-nav .nav-link {
            padding: 0.5rem 1rem;
            margin: 0 0.25rem;
            font-size: 1rem; /* Adjusted for mobile but still larger than original */
        }

...
<main class="hotel-detail-main">
    ...
    <section class="hotel-header position-relative" style="background: linear-gradient(rgba(89, 196, 90, 0.9), rgba(89, 196, 90, 0.8)), url('https://tse2.mm.bing.net/th?id=OIP.9kAsse9fe4MJ0rpIl_zuWQHaEK&pid=Api') center/cover; color: white; padding: 120px 0 80px 0;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1 class="hotel-title display-4 mb-3">Silver Sand Sea Princess Beach Resort</h1>
                    <div class="hotel-rating mb-3">
                        ...
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <span class="ms-2">(4.7/5 from reviews)</span>
                    </div>
                    <p class="hotel-location fs-5">
                        <i class="fas fa-map-marker-alt me-2"></i> Wandoor Beach, New Wandoor, Port Blair, South Andaman
            ...
            <div class="row g-3">
                <div class="col-md-8">
                    <div class="position-relative gallery-main">
                        <img src="https://tse4.mm.bing.net/th?id=OIP.8i6vfEXexKXlJ5GsCq8oAgHaEK&pid=Api" alt="Silver Sand Resort Main Image" class="img-fluid rounded main-image" style="width: 100%; height: 500px; object-fit: cover;">
                    ...
                    <div class="row g-3">
                        <div class="col-6 col-md-12">
                            <div class="gallery-item position-relative">
                                <img src="https://tse2.mm.bing.net/th?id=OIP.jRh0rJonM3t2T_SZSwoxUAHaFo&pid=Api" alt="Gallery Image 1" class="img-fluid rounded" style="width: 100%; height: 240px; object-fit: cover;">
                                <div class="overlay"></div>
                            </div>
                        </div>
                        <div class="col-6 col-md-12">
                            <div class="gallery-item position-relative">
                                <img src="https://tse1.mm.bing.net/th?id=OIP.12cQGxJH8kVAJ6H70JXh-QHaE8&pid=Api" alt="Gallery Image 2" class="img-fluid rounded" style="width: 100%; height: 240px; object-fit: cover;">
                                <div class="overlay"></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="description-card bg-white p-4 rounded shadow-sm">
                        ...
                        <p class="mt-3 lead">Silver Sand Sea Princess Beach Resort offers a luxurious escape on Wandoor Beach, Port Blair. Surrounded by lush greenery, it provides a serene atmosphere for travelers looking to experience the beauty of the Andaman Sea. Guests enjoy well-appointed rooms, beachfront access, and top-notch amenities.</p>
                        ...
                        <div id="amenities" class="amenities mt-5">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-4">
                                    <div class="amenity-card p-3 border rounded text-center">
                                        <i class="fas fa-beach-chair fa-2x mb-3" style="color: #59c45a;"></i>
                    ...
                    <div class="quick-facts bg-white p-4 rounded shadow-sm">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="d-flex align-items-center">
                                <i class="fas fa-phone me-3" style="color: #59c45a;"></i>
                                <div>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="room-card bg-white rounded shadow-sm h-100">
                        <div class="position-relative">
                            <img src="https://tse1.mm.bing.net/th?id=OIP.12cQGxJH8kVAJ6H70JXh-QHaE8&pid=Api" alt="Standard Room" class="img-fluid rounded-top" style="width: 100%; height: 250px; object-fit: cover;">
                            <span class="badge bg-success position-absolute top-0 end-0 m-3">Garden Facing</span>
                        </div>
                        <div class="room-info p-4">
                            <h3 class="h4 mb-3">Standard Room</h3>
                            <p class="text-muted mb-4">Cozy room with garden view</p>
                ...
                <div class="col-md-4">
                    <div class="room-card bg-white rounded shadow-sm h-100">
                        <div class="position-relative">
                            <img src="https://tse4.mm.bing.net/th?id=OIP.8i6vfEXexKXlJ5GsCq8oAgHaEK&pid=Api" alt="Deluxe Room" class="img-fluid rounded-top" style="width: 100%; height: 250px; object-fit: cover;">
                        </div>
                        <div class="room-info p-4">
                            <h3 class="h4 mb-3">Deluxe Room (Sea Facing)</h3>
                            <p class="text-muted mb-4">Room with a beautiful sea view</p>
                            <div class="price-book d-flex align-items-center justify-content-between">
                                <div class="price">
                ...
                <div class="col-md-4">
                    <div class="room-card bg-white rounded shadow-sm h-100">
                        <div class="position-relative">
                            <img src="https://tse2.mm.bing.net/th?id=OIP.jRh0rJonM3t2T_SZSwoxUAHaFo&pid=Api" alt="Luxury Room" class="img-fluid rounded-top" style="width: 100%; height: 250px; object-fit: cover;">
                        </div>
                        <div class="room-info p-4">
                            <h3 class="h4 mb-3">Luxury Room (Beach Front)</h3>
                            <p class="text-muted mb-4">Luxurious room right on the beachfront</p>
                            <div class="price-book d-flex align-items-center justify-content-between">
                                <div class="price">

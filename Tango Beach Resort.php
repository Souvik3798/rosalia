            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4 text-end">
                    <div class="price-tag glass-morphism p-4">
                        ...
                        <button class="btn btn-light btn-lg w-100" onclick="window.open('https://wa.me/8900943735?text=I want to check availability at Tango Beach Resort', '_blank')"><i class="fas fa-calendar-alt me-2"></i>Check Availability</button>
                    </div>
                </div>
            </div>
        </div>
